# Cmparison : Custom Built vs Transfer Learning CNN
This is part of a project i did for the course Machine Learning for Earth Sciences (MLEES) during my Master BEC CEE. 


# Organisation : 
the CNN.ipynb is a jupiter notebook with all the steps i used to make my **Custom Built** CNN. From data-scarping of the Data (images) and API resquest, 
to the training, optimization choice, and evalutation done including **Explanatory IA**
